...
import { disableNativeComponentFrames, enableComponentStackLocations } from "./ReactFeatureFlags";
...
import { REACT_SUSPENSE_TYPE, REACT_SUSPENSE_LIST_TYPE, REACT_FORWARD_REF_TYPE, REACT_MEMO_TYPE, REACT_LAZY_TYPE } from "./ReactSymbols";
 ...
 let reentry = false;
 let componentFrameCache: WeakMap<any, any>;
 if (__DEV__) {
   ...
   if (typeof type === 'object') {
     switch (type.$$typeof) {
       ...
       case REACT_LAZY_TYPE: {
         const lazyComponent: LazyComponent<any, any> = type;
