...
import { findFiberRoot, getBoundingRect, getTextContent, Instance, isHiddenSubtree, matchAccessibilityRole, setFocusIfFocusable, setupIntersectionObserver, supportsTestSelectors } from "./ReactFiberHostConfig";
import { Fiber } from "./ReactInternalTypes";
import { HostComponent, HostText } from "./ReactWorkTags";

let COMPONENT_TYPE:any = 0b000;
let HAS_PSEUDO_CLASS_TYPE: any = 0b001;
let ROLE_TYPE: any = 0b010;
let TEST_NAME_TYPE: any = 0b011;
let TEXT_TYPE: any = 0b100;
