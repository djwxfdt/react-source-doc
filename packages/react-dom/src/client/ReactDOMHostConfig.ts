...
import { createElement, createTextNode, diffHydratedProperties, diffHydratedText, diffProperties, setInitialProperties, trapClickOnNonInteractiveElement, updateProperties, warnForUnmatchedText } from "./ReactDOMComponent";
