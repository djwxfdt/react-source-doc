 ...
 import { EventPriority, isHigherEventPriority } from '../../../react-reconciler/src/ReactEventPriorities.old';
...
import { enableSelectiveHydration } from '../../../shared/ReactFeatureFlags';
 ...
 import { DOMEventName } from './DOMEventNames';
  import {EventSystemFlags, IS_REPLAYED} from './EventSystemFlags';
...
import { attemptToDispatchEvent } from './ReactDOMEventListener';
 ...
 export function clearIfContinuousEvent(
   ...
   switch (domEventName) {
     ...
     case 'pointerover':
     case 'pointerout': {
       const pointerId = ((nativeEvent as any) as PointerEvent).pointerId;
 ...
 export function queueIfContinuousEvent(
   ...
   switch (domEventName) {
     ...
     case 'pointerover': {
       const pointerEvent = ((nativeEvent as any) as PointerEvent);
